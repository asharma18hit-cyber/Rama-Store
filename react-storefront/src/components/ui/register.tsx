...
import SmokeRing, { smokeRingPresets } from './smoke-ring';
...
export const RegisterPage: React.FC<RegisterPageProps> = ({
  ...
  description = "Join us to shop millions of products and track your orders",
  testimonials = [],
  onRegister,
  onGoogleSignIn,
  onSignInRedirect,
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
        ...
        <div className="w-full max-w-md my-auto py-8">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-4" onSubmit={onRegister}>
              ...
              <div className="animate-element animate-delay-500">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Create a password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" required />
              ...
              <div className="animate-element animate-delay-700 flex items-center justify-between text-sm py-1">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" name="terms" className="custom-checkbox" required />
                  <span className="text-foreground/90 font-medium">I agree to the Terms of Service & Privacy Policy</span>
                </label>
              </div>

              <button type="submit" className="animate-element animate-delay-800 w-full rounded-2xl bg-zinc-900 py-4 font-medium text-white hover:bg-zinc-800 transition-colors">
                Create Account
              </button>
            </form>
            ...
            <div className="animate-element animate-delay-900 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-muted-foreground bg-background absolute">Or register with</span>
            </div>

            <button onClick={onGoogleSignIn} className="animate-element animate-delay-1000 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors">
                <GoogleIcon />
      ...
      <section className="hidden md:block flex-1 relative p-4">
        {/* Absolute-positioned background SmokeRing shader */}
        <div className="absolute inset-4 rounded-3xl bg-zinc-950 overflow-hidden">
          <SmokeRing
            {...(smokeRingPresets[0].params as any)}
            colors={["#E8A33D", "#C1452E", "#1B2130"]}
