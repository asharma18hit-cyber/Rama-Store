...
/// App color system for Rama Store:
...
class AppColors {
  ...
  // Gold & Amber Accents (Loyalty & Badges)
  ...
  // Light Mode Colors
  static const Color lightBackground = Color(0xFFF8F9FA); // Clean Surface Bright
  ...
  static const Color error = Color(0xFFBA1A1A);           // Red Error
